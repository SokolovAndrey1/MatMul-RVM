...
template <typename T>
class GemmRefNonSquare : public ::testing::Test
{
public:
...
TEST(GemmRVMBlocked, SimpleTets_1x1) {
    const size_t rows = 1;
    const size_t cols = 1;
    const float A[] = {1.0f};
    const float B[] = {1.0f};
...
TEST(GemmRVMBlocked, SimpleTets_2x2) {
    const size_t rows = 2;
    const size_t cols = 2;
...
TEST(GemmRVMBlocked, SimpleTets_3x3) {
    const size_t rows = 3;
    const size_t cols = 3;
...
TYPED_TEST_CASE(GemmRefNonSquare, TypesNonSqare);

TYPED_TEST(GemmRefNonSquare, Zero_ABC) 
{
...
TYPED_TEST(GemmRefNonSquare, Rand_AB_Zero_C) 
{
    using ElemType   = typename TestFixture::ElemType;
    using VectorType = typename TestFixture::VectorType;
...
TYPED_TEST(GemmRefNonSquare, Rand_ABC) 
{
    using ElemType   = typename TestFixture::ElemType;
    using VectorType = typename TestFixture::VectorType;
